  ...
  <div className="flex">
    ...
    >
      <SwiperSlide> <Image className='w-full h-[400px] object-cover'  src={img3} alt="img1" width={600} height={300}/></SwiperSlide>
        <SwiperSlide>
        <Image className='w-full h-[400px] object-cover' src={img4} alt="img1" width={600} height={300}/></SwiperSlide>
    ...
    <Image className='w-full h-[200px] object-cover' src={img2} alt="img2" width={200} height={200}/>
